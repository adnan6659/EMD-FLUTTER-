...
class DataTableModal extends StatefulWidget {
  const DataTableModal({Key? key}) : super(key: key);

  @override
  _DataTableModalState createState() => _DataTableModalState();
}

class _DataTableModalState extends State<DataTableModal> {
