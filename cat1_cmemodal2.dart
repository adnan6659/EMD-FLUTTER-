...
class cat1_cmemodal2 extends StatefulWidget {
  const cat1_cmemodal2({Key? key}) : super(key: key);

  @override
  _cat1_cmemodal2State createState() => _cat1_cmemodal2State();
}

class _cat1_cmemodal2State extends State<cat1_cmemodal2> {
  ...
  Future<void> fetchData() async {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse('http://arizshad-002-site18.atempurl.com/api/MandatoryDetails'),
        headers: {
          'Content-Type': 'application/json',
          'Authorization': accessToken!,
        },
        body: jsonEncode({'RegistrationId': userId, 'LicenseId': 2, 'FinId': '2'}),
      );
